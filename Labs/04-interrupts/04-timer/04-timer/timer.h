...
#define TIM0_overflow_128u()	TCCR0B &= ~((1<<CS02); TCCR0B |= ((1<<CS01) | (1<<CS00));
#define TIM0_overflow_1ms()		TCCR0B &= ~((1<<CS00); TCCR0B |= ((1<<CS01) | (1<<CS00));
...
#define TIM2_overflow_4s()      TCCR2B &= ~(1<<CS11); TCCR2B |= (1<<CS22) | (1<<CS20);
