...
#define TIM0_overflow_1ms()		TCCR0B &= ~((1<<CS01)|(1<<CS00)); TCCR0B |= (1<<CS02);		//011
#define TIM0_overflow_4ms()		TCCR0B &= ~(1<<CS01); TCCR0B |= ((1<<CS02)|(1<<CS00));		//100	
#define TIM0_overflow_16ms()	TCCR0B &= ~(1<<CS00); TCCR0B |= ((1<<CS02) | (1<<CS00));	//101
...
#define TIM2_overflow_512u()	TCCR2B &= ~(1<<CS20); TCCR2B |= ((1<<CS22) | (1<<CS21));	//011
#define TIM2_overflow_1ms()		TCCR2B &= ~((1<<CS21)|(1<<CS20)); TCCR2B |= (1<<CS22);		//100
#define TIM2_overflow_2ms()		TCCR2B &= ~(1<<CS21); TCCR2B |= ((1<<CS20) | (1<<CS22));	//101
